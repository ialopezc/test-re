...
const producto = usePage().props.producto;
...
const submit = () => {
    form.patch(route('productos.update',form.id), {
        onFinish: () => form.reset(),
    });
};
</script>
                    ...
                    <section class="p-4">
                        <form @submit.prevent="submit" class="space-y-6">
                            <div>
                                ...
                                <NumberInput id="id" type="number" class="mt-1 block w-full" v-model="form.id" required
